...
// MOBILE
    ...
    Mobile = {
        ...
        menu: function () {
            ...
            var login = $('<a />').append($('.navbar-fixed-top .navbar-nav #nav-login').clone().prepend('<span class="fa fa-user"></span>')).html();
    ...
    Actions = {
        ...
        comprar: function () {
            $('.comprar').each(function () {
                ...
                var icone = '<img src="/web-files/img/assets/icon-approved.png" style="width: 46px;opacity: 1;margin-right: 6px;" />';
                ...
                html += "<a class='btn btn-dark mfp-close' style='margin-right: 26px'>VER OUTROS PRODUTOS</a>";
