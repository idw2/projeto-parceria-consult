	...
	array( "name" => "nav-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Footer Credit",
				   ...
				   "type" => "textarea",
				   "std" => "<a href=\"http://www.theme-junkie.com\">WordPress Magazine Theme</a> by <a href=\"http://www.theme-junkie.com\">Theme Junkie</a> &middot; <a href=\"#\">Back to top</a>",
				   "desc" => "desc",),	   
		...
		array( "name" => "general-2",
			...
			array( "name" => "Your Facebook Page URL",
				   "id" => $shortname."_facebook_page_url",
				   "type" => "text",
				   "std" => "http://www.facebook.com/yourpageurl",
				   "desc" => "desc",),
				   
			array( "name" => "Your Gooegle+ URL",
				   "id" => $shortname."_google_plus_url",
				   "type" => "text",
				   "std" => "https://plus.google.com/116387478398345310130",
				   "desc" => "desc",),	
				   
			array( "name" => "Your Newsletter URL",
				   "id" => $shortname."_newsletter_url",
				   "type" => "text",
				   "std" => "http://feedburner.google.com/fb/a/mailverify?uri=ThemeJunkie&loc=en_US",
				   "desc" => "desc",),

			array( "name" => "Your Custom RSS URL",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
            ...
            array( "name" => "Enable news ticker on homepage",
                   "id" => $shortname."_news_ticker_enable",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc."),

            array( "name" => "Number of posts to show on news ticker",
                   "id" => $shortname."_news_ticker_num",
                   "type" => "text",
                   "std" => "3",
                   "desc" => "desc."),

			array( "name" => "Input comma-separated tags for news ticker",
            ...
            array( "name" => "Number of posts to show on featured slider",
			...
			array( "name" => "Enable social share buttons on homepage",
                   "id" => $shortname."_home_share_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),
		...
		array( "name" => "layout-2",
			...
			array( "name" => "Enable social share buttons on posts",
                   "id" => $shortname."_single_share_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "desc."),			   
