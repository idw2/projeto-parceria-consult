 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '[SECRET_KEY1]');
define('SECURE_AUTH_KEY',  '[SECRET_KEY2]');
define('LOGGED_IN_KEY',    '[SECRET_KEY3]');
define('NONCE_KEY',        '[SECRET_KEY4]');
define('AUTH_SALT',        '[SECRET_KEY5]');
define('SECURE_AUTH_SALT', '[SECRET_KEY6]');
define('LOGGED_IN_SALT',   '[SECRET_KEY7]');
define('NONCE_SALT',       '[SECRET_KEY8]');
